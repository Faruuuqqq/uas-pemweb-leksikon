    ...
    <div class="register-card">
        ...
        <form action="<?= site_url('register') ?>" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control form-control-neo" id="username" name="username" value="<?= old('username') ?>" required>
            </div>
            <div class="mb-3">
                <label for="email" class="form-label fw-bold">Email</label>
                <input type="email" class="form-control form-control-neo" id="email" name="email" value="<?= old('email') ?>" required>
            </div>
            <div class="mb-3">
