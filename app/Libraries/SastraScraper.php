...
class SastraScraper
{
    ...
    public function search(string $term): array
    {
        log_message(
            'info',
            'SastraScraper: Direct scraping of sastra.org/leksikon for the given search term '
            . 'is complex due to AJAX-based search. Returning placeholder result for term: ' . $term
        );

        $results = [];
        $results[] = [
            'word'       => $term,
            'definition' => 'Search on sastra.org/leksikon uses complex AJAX and requires '
                          . 'reverse-engineering. Direct scraping is currently not supported.',
