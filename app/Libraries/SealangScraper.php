    ...
    public function searchLibrary(string $term): array
    {
        ...
        try {
            ...
            if ($response->getStatusCode() === 200) {
                ...
                $results[] = [
                    'word'       => $term,
                    'definition' => 'Search functionality for sealang.net/library/ is complex. Results may vary or require specific dictionary page navigation.',
    ...
    public function searchOjed(string $term): array
    {
        ...
        try {
            ...
            if ($response->getStatusCode() === 200) {
                ...
                $results[] = [
                    'word'       => $term,
                    'definition' => 'Search functionality for sealang.net/ojed/ is complex. Results may vary or require specific dictionary page navigation.',
